  ...
  const handleChargerTypeChange = (type, checked) => {
    if (checked) {
      setFormData((prev) => ({
        ...
        pricePerMinute: { ...prev.pricePerMinute, [type]: 0.5 },
        availability: { ...prev.availability, [type]: 1 },
      }))
    } else {
        ...
        <div className="fixed inset-0 backdrop-blur-sm bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-white">Add New Charging Station</h2>
                ...
                {chargerTypeOptions.map((type) => (
                  <div key={type} className="border border-gray-600 rounded-lg p-4">
                    <div className="flex items-center mb-3">
                      ...
                      />
                      <label htmlFor={type} className="ml-2 text-white font-medium">
                        {type}
                      </label>
                    </div>
