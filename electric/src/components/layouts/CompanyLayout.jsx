  ...
  return (
    <div className="min-h-screen w-full relative bg-black">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 80% 60% at 50% 0%, rgba(74, 158, 255, 0.25), transparent 70%),
      ...
      <div className="relative z-10 flex min-h-screen bg-transparent">
        ...
        <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
          <div className="flex flex-col flex-grow border-r bg-gradient-to-br backdrop-blur-md border border-gray-900 shadow-md">
        ...
        <div className="flex-1 lg:pl-64">
          {/* Header */}
          <header className="border-b h-16 flex items-center justify-between px-6 bg-gradient-to-br backdrop-blur-lg border border-gray-900 p-6 shadow-md">
